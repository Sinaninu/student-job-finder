...
export default function Login() {
  ...
  const role = requestedRole === 'company' || requestedRole === 'admin' ? requestedRole : 'student'
  ...
  return (
    <div className="login-page">
      <div className="login-card">
        ...
        <p className="register-link">
          <Link to="/login?role=student">Student login</Link> · <Link to="/login?role=company">Company login</Link> · <Link to="/login?role=admin">Admin login</Link>
        </p>
      </div>
    </div>
  )
